...
use PyzTest\Zed\Payment\PageObject\SalesPage;
...
{
    use _generated\PaymentTesterActions;
    ...
    public function __construct(Scenario $scenario)
    {
        ...
        if ($this->seeThatDynamicStoreEnabled()) {
            $this->markTestSkipped('Test is valid for Static Store mode only.');
        }
