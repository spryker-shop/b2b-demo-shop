...
$config[\Spryker\Shared\Category\CategoryConstants::CATEGORY_READ_CHUNK] = 10000;

$config[\Spryker\Shared\Category\CategoryConstants::CATEGORY_IS_CLOSURE_TABLE_EVENTS_ENABLED] = false;
