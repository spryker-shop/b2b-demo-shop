...
/**
 * Skeleton subclass for representing a row from the 'spy_product_offer_shipment_type_storage' table.
 *
 *
 *
 ...
 */
class SpyProductOfferShipmentTypeStorage extends BaseSpyProductOfferShipmentTypeStorage
{
}
