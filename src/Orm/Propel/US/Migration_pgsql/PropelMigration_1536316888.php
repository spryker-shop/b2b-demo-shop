 ...
 * up to version 1536316888.
 * Generated on 2018-09-07 10:41:28 by vagrant
 */
class PropelMigration_1536316888
{
    public $comment = '';
...
CREATE INDEX "spy_quote_company_user-fk_company_user" ON "spy_quote_company_user" ("fk_company_user");
...
(
    ...
    CONSTRAINT "spy_file_directory_localized_attributes-unique-fk_file_director" UNIQUE ("fk_file_directory","fk_locale")
);
...
CREATE INDEX "spy_price_product_merchant_relationship-index-fk_product_abstra" ON "spy_price_product_merchant_relationship" ("fk_product_abstract");
...
(
    ...
    CONSTRAINT "spy_price_product_abstract_merchant_relationship_storage-unique" UNIQUE ("key")
);
...
(
    ...
    CONSTRAINT "spy_price_product_concrete_merchant_relationship_storage-unique" UNIQUE ("key")
);
...
CREATE SEQUENCE "spy_product_abstract_packaging_storage_pk_seq";

CREATE TABLE "spy_product_abstract_packaging_storage"
(
    "id_product_abstract_packaging_storage" INT8 NOT NULL,
    "fk_product_abstract" INTEGER NOT NULL,
    "data" TEXT,
    "key" VARCHAR NOT NULL,
    "created_at" TIMESTAMP,
    "updated_at" TIMESTAMP,
    PRIMARY KEY ("id_product_abstract_packaging_storage")
);

CREATE INDEX "spy_product_abstract_packaging_storage-fk_product_abstract" ON "spy_product_abstract_packaging_storage" ("fk_product_abstract");
...
(
    ...
    "fk_product" INTEGER NOT NULL,
    PRIMARY KEY ("fk_product_list","fk_product")
);
...
(
    "fk_product_list" INTEGER NOT NULL,
    "fk_category" INTEGER NOT NULL,
    PRIMARY KEY ("fk_product_list","fk_category")
);
...
(
    ...
    CONSTRAINT "spy_product_abstract_product_list_storage-unique-key" UNIQUE ("key")
);
...
(
    ...
    CONSTRAINT "spy_product_concrete_product_list_storage-unique-key" UNIQUE ("key")
);
...
(
    ...
    "has_lead_product" BOOLEAN DEFAULT \'f\',
    "created_at" TIMESTAMP,
    "updated_at" TIMESTAMP,
...
CREATE SEQUENCE "spy_product_packaging_unit_amount_pk_seq";

CREATE TABLE "spy_product_packaging_unit_amount"
(
    "id_product_packaging_unit_amount" INTEGER NOT NULL,
    "fk_product_packaging_unit" INTEGER NOT NULL,
    "default_amount" INTEGER NOT NULL,
    "is_variable" BOOLEAN DEFAULT \'f\' NOT NULL,
    "amount_min" INTEGER,
    "amount_max" INTEGER,
    "amount_interval" INTEGER,
    "created_at" TIMESTAMP,
    "updated_at" TIMESTAMP,
    PRIMARY KEY ("id_product_packaging_unit_amount"),
    CONSTRAINT "spy_product_packaging_unit_amount-unique-fk_product_packaging_u" UNIQUE ("fk_product_packaging_unit")
);

CREATE SEQUENCE "spy_product_packaging_lead_product_pk_seq";

CREATE TABLE "spy_product_packaging_lead_product"
(
    "id_product_packaging_lead_product" INTEGER NOT NULL,
    "fk_product_abstract" INTEGER NOT NULL,
    "fk_product" INTEGER NOT NULL,
    "created_at" TIMESTAMP,
    "updated_at" TIMESTAMP,
    PRIMARY KEY ("id_product_packaging_lead_product"),
    CONSTRAINT "spy_product_packaging_lead_product-unique-fk_product_abstract" UNIQUE ("fk_product_abstract"),
    CONSTRAINT "spy_product_packaging_lead_product-unique-fk_product" UNIQUE ("fk_product")
);
...
(
    ...
    "data" TEXT,
    "locale" VARCHAR(16) NOT NULL,
    "mapping_resource_key" VARCHAR,
    "key" VARCHAR,
    "created_at" TIMESTAMP,
    "updated_at" TIMESTAMP,
    PRIMARY KEY ("id_product_concrete_storage"),
    CONSTRAINT "spy_product_concrete_storage-unique-mapping-resource-key" UNIQUE ("mapping_resource_key"),
...
(
    ...
    CONSTRAINT "spy_product_abstract_storage-unique-mapping-resource-key" UNIQUE ("mapping_resource_key"),
...
(
    ...
    CONSTRAINT "spy_shopping_list_customer_storage-unique-key" UNIQUE ("key")
);
...
ALTER TABLE "spy_product_packaging_unit_amount" ADD CONSTRAINT "spy_product_packaging_unit_amount-fk_product_packaging_unit"
    FOREIGN KEY ("fk_product_packaging_unit")
    REFERENCES "spy_product_packaging_unit" ("id_product_packaging_unit")
    ON DELETE CASCADE;

ALTER TABLE "spy_product_packaging_lead_product" ADD CONSTRAINT "spy_product_packaging_lead_product-fk_product_abstract"
    FOREIGN KEY ("fk_product_abstract")
    REFERENCES "spy_product_abstract" ("id_product_abstract");

ALTER TABLE "spy_product_packaging_lead_product" ADD CONSTRAINT "spy_product_packaging_lead_product-fk_product"
    FOREIGN KEY ("fk_product")
    REFERENCES "spy_product" ("id_product");
...
DROP TABLE IF EXISTS "spy_product_abstract_packaging_storage" CASCADE;

DROP SEQUENCE "spy_product_abstract_packaging_storage_pk_seq";
...
DROP TABLE IF EXISTS "spy_product_packaging_unit_amount" CASCADE;

DROP SEQUENCE "spy_product_packaging_unit_amount_pk_seq";

DROP TABLE IF EXISTS "spy_product_packaging_lead_product" CASCADE;

DROP SEQUENCE "spy_product_packaging_lead_product_pk_seq";
