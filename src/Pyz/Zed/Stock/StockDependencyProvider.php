...
use Spryker\Zed\ProductPackagingUnit\Communication\Plugin\Stock\ProductPackagingUnitAvailabilityHandlerPlugin;
...
class StockDependencyProvider extends SprykerStockDependencyProvider
{
    ...
    protected function getStockUpdateHandlerPlugins(Container $container)
    {
        return [
            ...
            new ProductPackagingUnitAvailabilityHandlerPlugin(),
        ];
    }
}
