...
use Spryker\Zed\ProductPackagingUnit\Communication\Plugin\Checkout\PackagingUnitAvailabilityCheckoutPreCheckPlugin;
...
class CheckoutDependencyProvider extends SprykerCheckoutDependencyProvider
{
    ...
    protected function getCheckoutPreConditions(Container $container)
    {
        return [
            ...
            new PackagingUnitAvailabilityCheckoutPreCheckPlugin(),
        ];
    }
