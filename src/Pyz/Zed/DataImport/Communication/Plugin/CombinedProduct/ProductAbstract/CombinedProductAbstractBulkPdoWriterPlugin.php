 ...
 */
class CombinedProductAbstractBulkPdoWriterPlugin extends AbstractPlugin implements DataSetWriterPluginInterface
{
    /**
    ...
    {
        $this->getFacade()->writeCombinedProductAbstractPdoDataSet($dataSet);
    }
    ...
    {
        $this->getFacade()->flushCombinedProductAbstractPdoDataImporter();
    }
}
